<template>
    <jet-action-section>
        ...
        <template #description>
            <div class="hidden md:block">{{ __('Manage and log out your active sessions on other browsers and devices.') }}</div>
        </template>
        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                <jet-button @click="confirmLogout">
                    {{ __('Logout from all browser sessions') }}
                </jet-button>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <jet-input type="password" class="mt-1 block w-3/4" placeholder="Heslo"
                                    ref="password"
