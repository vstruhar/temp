<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            <div class="hidden md:block">{{ __('Ensure your account is using a long, random password to stay secure.') }}</div>
        </template>

        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" :value="__('Current password')" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" :value="__('New password')" />
