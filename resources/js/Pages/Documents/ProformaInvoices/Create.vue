<template>
    <app-layout :title="title">
        ...
        <jet-alert v-if="companyDetailsMissing" type="warning" class="-mt-4 mb-6">
        ...
        <jet-form-section @submitted="create" :with-title="false" :with-card="false">
            <template #form>
                ...
                <jet-card :title="__('General information')" class="order-1 col-span-6 lg:col-span-4 sm:pb-8">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <jet-label for="inputDocumentNumber" :value="__('Proforma invoice number')" required/>
                        ...
                        <!-- Name -->
                        <div class="col-span-6 sm:col-span-3">
                            <jet-label for="inputName" :value="__('Proforma invoice name')"/>
                        ...
                        <div class="col-span-6 md:col-span-2">
                            <jet-label :value="__('Proforma invoice language')"/>
                    ...
                    <table id="invoice-items" class="divide-y divide-gray-200 -mt-4 w-full">
                        ...
                        <template v-for="(item, index) in form.items" :key="`item-${index}`">
                            <tr class="grid grid-cols-6 gap-x-3 gap-y-3 lg:table-row p-4 w-full">
                                ...
                                <!-- Price with no tax -->
                                <jet-data-cell :name="__('Total')" class="col-span-2 whitespace-nowrap align-top" padding="lg:px-2 lg:py-4 lg:min-w-[100px] lg:max-w-[120px]">
                                    <div class="flex rounded-md shadow-sm">
                ...
                <!-- ISSUED BY -->
                <jet-card :title="__('Proforma invoice issued by')" class="order-6 col-span-6 pb-8 mb-6">
                    <div class="grid grid-cols-6 gap-6">
                        <!-- Issued by -->
            ...
            <template #actions>
                <jet-back-button :url="route('documents', 'proforma-invoices')" :disabled="form.processing"></jet-back-button>
...
<script>
    ...
    export default defineComponent({
        ...
        props: [
            ...
            'companyDetailsMissing', 'documentNumberOptions', 'countryDropdownItems', 'userDefaults',
        ],
        ...
        computed: {
            title() {
                return this.document
                    ? this.__('Duplicating proforma invoice') + ': ' + this.document.number
                    : this.__('New proforma invoice');
            },
        ...
        methods: {
            create() {
                ...
                this.form.post(route('documents.store', this.type), {
                    onSuccess: () => {
