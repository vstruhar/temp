                ...
                <jet-card :title="__('General information')" class="order-1 col-span-6 lg:col-span-4 sm:pb-8">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <jet-label for="inputInvoiceNumber" :value="__('Proforma invoice number')" required/>
...
<script>
    ...
    export default defineComponent({
        ...
        props: ['document', 'bankAccounts', 'clients', 'documentCompanyName', 'countryDropdownItems'],
        ...
        methods: {
            update() {
                ...
                this.form.put(route('documents.update', ['proforma-invoices', this.document.id]), {
                    onSuccess: () => {
                        if (this.downloadPdf) {
                            return axios.get(route('documents.download', ['proforma-invoices', this.document.id]), {responseType: 'blob'})
                                .then(response => {
